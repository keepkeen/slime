...
> 适用快照：`main@3778dbf6`（v0.3.2，扫描日期 2026-08-29）。题库中的“参考回答”是组织答案的骨架，不是逐字背诵稿。涉及生产规模、吞吐或稳定性的数字必须来自你自己的实验，不要用仓库宣传语代替证据。各厂公开面经的真题精讲见 [11. 厂商真题](11-company-interview-questions.md)。
